...
```
curl -s https://www.iac-bazaar.com/api/artifacts/gcp-cloud-nat/verification
```

The receipt names every check that ran, when it ran, and the SHA-256 of the
archive it describes. Full detail: [www.iac-bazaar.com/catalog/gcp-cloud-nat](https://www.iac-bazaar.com/catalog/gcp-cloud-nat)

## Usage

```hcl
module "cloud_nat" {
  source  = "registry.terraform.io/CyberCoreSystems/cloud-nat/google"
  version = "~> 1.0"
